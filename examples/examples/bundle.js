...
// a simple example using ClickHere
'use strict';
...
var _srcClickHere = require('../src/ClickHere');

var _srcClickHere2 = _interopRequireDefault(_srcClickHere);

var Example1 = (function (_React$Components) {
  _inherits(Example1, _React$Components);

  function Example1() {
    _classCallCheck(this, Example1);

    _get(Object.getPrototypeOf(Example1.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(Example1, [{
    ...
    value: function render() {
      _react2['default'].createElement(
        ...
        'Hello, stranger!',
        _react2['default'].createElement(
          _srcClickHere2['default'],
          null,
          _react2['default'].createElement(
            'a',
            { href: 'http://imgur.com/a/J7kZJ' },
            'Click here'
          )
        ),
...
;
debugger;
_react2['default'].render(_react2['default'].createElement(Example1, null), window.document.getElementById('app'));


},{"../src/ClickHere":167,"react":166}],2:[function(require,module,exports){
...
},{"react/lib/ReactComponent":45,"react/lib/ReactCompositeComponent":48}],4:[function(require,module,exports){
'use strict';
...
},{"./applyStyles":6,"react/lib/Object.assign":37,"react/lib/ReactElement":68}],5:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./recalcMediaQueryStyles":9,"_process":2,"react/lib/Object.assign":37}],6:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":2,"react/lib/CSSProperty":14}],7:[function(require,module,exports){
'use strict';
...
},{"./ReactCompositeComponentExtended.js":3,"./ReactElementExtended":4,"./applyMediaQueries":5,"./generateUniqueCSSClassName":7,"./stylesToCSS":10,"_process":2,"react/lib/ExecutionEnvironment":31,"react/lib/Object.assign":37}],9:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMediaQueries":5,"./applyStyles":6,"_process":2,"react/lib/Object.assign":37,"react/lib/ReactElement":68,"react/lib/ReactUpdateQueue":97,"react/lib/ReactUpdates":98}],10:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./unsupportedPseudoClasses":11,"_process":2,"react/lib/CSSProperty":14,"react/lib/hyphenateStyleName":144}],11:[function(require,module,exports){
/**
...
var ClickHere = (function (_React$Component) {
  _inherits(ClickHere, _React$Component);

  _createClass(ClickHere, null, [{
    key: 'propsTypes',
    value: {
  ...
  function ClickHere(props) {
    _classCallCheck(this, ClickHere);

    _get(Object.getPrototypeOf(ClickHere.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(ClickHere, [{
    ...
    value: function animate() {
      ...
      setInterval(function () {
        if (_this.state.size >= _this.props.max) {
          _this.setState({ direction: -1 });
        } else if (_this.state.size <= _this.props.min) {
          _this.setState({ direction: 1 });
        }
        var size = _this.state.size + _this.state.direction;
    ...
    key: 'render',
    value: function render() {
      var delta = Math.floor((this.props.max - this.state.size) / 2) - 10;

      // TODO: color, width, left position could be in props
      var style = _reactStyle2['default'].create({
        pointer: {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('div', { style: style.pointer }),
        this.props.children
      );
    }
  }]);
...
exports['default'] = ClickHere;
module.exports = exports['default'];


},{"react":166,"react-style":8}]},{},[1])


//# sourceMappingURL=../examples/examples/bundle.js.map